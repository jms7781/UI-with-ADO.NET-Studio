...
namespace ADO.NET_Studio
{
    public partial class NewConnectionUI : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var result = MessageBox.Show($"Are you sure you want to delete '{name}'?", "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
